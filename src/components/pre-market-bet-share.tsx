  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {/* Main Content Card */}
        <div className="relative mx-4 mb-6 rounded-2xl bg-white p-4 shadow-lg">
          {/* User Info */}
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center space-x-1">
              ...
              <div className="sbg-gray-300 h-14 w-14 rounded-lg p-0.5">
                <Image
                  src={`/img/test-player.png`}
                  width={300}
                  height={300}
                  alt="player image"
          ...
          >
            ...
            >
              ...
              Will Ilia Topuria win by KO/TKO tonight?
            </div>
            <div className="mt-1 text-sm text-gray-600">Outcome: Yes</div>
          </div>
